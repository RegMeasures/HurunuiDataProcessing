...
%
% DateTime = N x 1 matrix of datetime values
...
Interval = (DateTime(2,1)-DateTime(1,1));
DataSequence = round(((DateTime(:,1) - DateTime(1,1))) / Interval) + 1;

DateTime2 =DateTime(1,1) + (0:DataSequence(end)-1)' * Interval;
