function [Channel,RMSE,ExitFlag] = FitChannel_4par(Q, E_us, E_ds, Manning)
...
OptimFun = @(ChannelParams)ChannelError_4par(ChannelParams, Q, E_us, E_ds, Manning);
...
error = ChannelError_4par(ChannelParams, Q, E_us, E_ds, Manning, true);
%error = ChannelError_4par(ChannelParams, Q, E_us, E_ds, Manning, false);
