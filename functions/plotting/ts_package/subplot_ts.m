...
%      ytix:   array of y tick marks (in ascending order indicates regular
%              y axis; in decending order indicates reversed y axis)
%      lbl:    ylabel text
...
%      varargin: add up to 8 time series to plot by passing 's1' (for
...
%
%   Author: A. Seltzer
%   Modifications by Richard Measures
%
