...
YTicsRunup = -40:40:80; YLblRunup = 'Runup height';
...
T4 = permute(ShortlistPhotos.OffsetOK(:,4,:),[1,3,2]); T4 = T4(:);
...
WidthH = subplot_ts(ax, 2, YTicsWidth, YLblWidth, 1.3, -1.5,...
                    ...
                    's5', TPlotDates, T11, '.', 'MarkerSize', 6, 'color', WidthColors(6,:), ...
                    's6', TPlotDates, T12, '.', 'MarkerSize', 6, 'color', WidthColors(7,:));%, ...
%                     's7', TPlotDates, T13, '.', 'MarkerSize', 6, 'color', WidthColors(7,:), ...
%                     's8', TPlotDates, T14, '.', 'MarkerSize', 6, 'color', WidthColors(8,:));

LegWidth = legend(ax(3),[WidthH{1}, WidthH{2}, WidthH{3}, WidthH{4},...
                         WidthH{5}, WidthH{6}], ...
                  {'#5', '#6', '#7', '#8', '#11', '#12'});
set(LegWidth, 'Position', [0.8, 0.64, 0.08, 0.0772], ...
              'box', 'on', 'EdgeColor', 'none', ...
              'color', [1,1,1])
% plot river flow
...
% runup plot
subplot_ts(ax, 5, YTicsRunup ,YLblRunup, 1, -1.5,...
           's1', datenum(LagoonTS.DateTime), LagoonTS.LstPot, '-k');
