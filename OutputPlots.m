...
YTicsFlow  = 0:200:800; YLblFlow  = {'River flow'; ...
                                     '(m^3\cdots^{-1})'};
YTicsLst   = -200:100:300; YLblLst   = {'Longshore transport, Q_s'; ...
                                        '(m^3\cdot day^{-1}, positive northwards)'};
...
SmoothedLstPot = SmoothedLstPot * 60*60*24; % convert to daily rate
