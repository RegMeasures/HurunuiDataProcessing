...
range=abs(max(max(ChannelPos.UsOffset(ChannelPos.UniqueTime>=XRange(1) & ...
                                      ChannelPos.UniqueTime<=XRange(2)), ...
                  ChannelPos.DsOffset(ChannelPos.UniqueTime>=XRange(1) & ...
                                      ChannelPos.UniqueTime<=XRange(2)))) - ...
          min(min(ChannelPos.UsOffset(ChannelPos.UniqueTime>=XRange(1) & ...
                                      ChannelPos.UniqueTime<=XRange(2)), ...
                  ChannelPos.DsOffset(ChannelPos.UniqueTime>=XRange(1) & ...
                                      ChannelPos.UniqueTime<=XRange(2)))));
scale=rangeFill/range;
mdp=(min(min(ChannelPos.UsOffset(ChannelPos.UniqueTime>=XRange(1) & ...
                                 ChannelPos.UniqueTime<=XRange(2)), ...
             ChannelPos.DsOffset(ChannelPos.UniqueTime>=XRange(1) & ...
                                 ChannelPos.UniqueTime<=XRange(2)))) + ...
     range/2) * scale;
