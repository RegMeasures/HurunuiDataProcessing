...
YTicsFlow  = 0:200:800; YLblFlow  = 'River flow (m^3/s)'; % 'River flow (m^3\cdots^{-1})';
YTicsLst   = -1200:600:1800; YLblLst   = {'Longshore transport, Q_s (m^3/day)'; ...
                                          '(positive northwards)'};
YTicsRunup = 1:1:5; YLblRunup = {'Wave runup height, \itR_{high}\rm'; ...
                                 '(daily max, m-LVD)'};
YTicsLevel = -1:1:3; YLblLevel = {'Water level (daily range, m-LVD)'; ...
                                   'Green = sea, Blue = lagoon'};
