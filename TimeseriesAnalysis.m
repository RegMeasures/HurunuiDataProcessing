...
% Also calculate offshore EAngle to use for modelling
WaveModTS.Co_div_Ch = 1 ./ tanh(2*pi*WaveModTS.Depth./WaveModTS.Wlen);
WaveModTS.EAngle_Offshore = asin(sin(WaveModTS.EAngle_10m) .* WaveModTS.Co_div_Ch);
...
histogram(rad2deg(WaveModTS.EAngle_Break), 'BinEdges', -90:5:90, ...
          'Normalization', 'probability')
% histogram(rad2deg(WaveModTS.EAngle_Offshore), 'BinEdges', -90:5:90, ...
%           'Normalization', 'probability')
YL = ylim;
...
LagoonTS.WaveHs = interp1(WaveModTS.DateTime,...
                          WaveModTS.Hsig,...
                          LagoonTS.DateTime);
LagoonTS.HsOffshore = interp1(WaveModTS.DateTime,...
                              WaveModTS.Hsig_Offshore,...
                              LagoonTS.DateTime);
...
LagoonTS.WavePower = interp1(WaveModTS.DateTime,...
                             WaveModTS.F_10m,...
                             LagoonTS.DateTime);
LagoonTS.EAngle_Offshore = interp1(WaveModTS.DateTime,...
                                   rad2deg(WaveModTS.EAngle_Offshore),...
                                   LagoonTS.DateTime);                       
