...
OnshoreWaves = BuoyTS.Angle>-pi/2 & BuoyTS.Angle<pi/2;
...
BuoyTS.LstPot(OnshoreWaves) = BuoyTS.HsM(OnshoreWaves).^(12/5) .* ...
                              BuoyTS.TsSec(OnshoreWaves).^(1/5) .* ...
                              (cos(BuoyTS.Angle(OnshoreWaves))).^(6/5) .* ...
                              sin (BuoyTS.Angle(OnshoreWaves));
...
figure
histogram(BuoyTS.LstPot)
plot(BuoyTS.Date,cumsum(BuoyTS.LstPot))
ylabel('Cumulative longshore transport potential')

figure
subplot(2,1,1)
histogram(BuoyTS.Runup1,'BinWidth',0.2)
xlim([0,10])
ylim([0,6000])
xlabel('Runup Stockdon et al (2006)')
subplot(2,1,2)
histogram(BuoyTS.Runup2,'BinWidth',0.2)
xlim([0,10])
ylim([0,6000])
...
LagoonTS.SeaLevel = interp1(HurunuiTide.DateTime,...
                            HurunuiTide.Final,...
                            LagoonTS.DateTime);
LagoonTS.WaveHs = interp1(BuoyTS.Date,...
                          BuoyTS.HsM,...
                          LagoonTS.DateTime);
LagoonTS.WaveTs = interp1(BuoyTS.Date,...
                          BuoyTS.TsSec,...
                          LagoonTS.DateTime);
LagoonTS.WaveAngle = interp1(BuoyTS.Date,...
                           BuoyTS.Angle,...
                           LagoonTS.DateTime);
LagoonTS.LstPot = interp1(BuoyTS.Date,...
                          BuoyTS.LstPot,...
                          LagoonTS.DateTime);
LagoonTS.Runup1 = interp1(BuoyTS.Date,...
                         BuoyTS.Runup1,...
                         LagoonTS.DateTime);
LagoonTS.Runup2 = interp1(BuoyTS.Date,...
                          BuoyTS.Runup2,...
                          LagoonTS.DateTime);
